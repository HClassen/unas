...
from ..oneshot.layers import SharedDWConv2dModule
from ..mobilenet import FIRST_CONV_CHANNELS, LAYER_SETTINGS
from ..utils import make_divisible


__all__ = ["dwconv2d_choice_block_ctor", "DWConv2dSearchSpace"]


def dwconv2d_choice_block_ctor(
    in_channels: int,
    out_channels: int,
    width_mult: float,
    round_nearest: int,
